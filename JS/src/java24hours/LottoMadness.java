...
public class LottoMadness extends JFrame {
     ...
     */
    private static final long serialVersionUID = 3072552887701904474L;
    ...
    JLabel got3Label = new JLabel("3 of ", JLabel.RIGHT);
    JTextField got3 = new JTextField("0");
    JLabel got4Label = new JLabel("4 of ", JLabel.RIGHT);
    JTextField got4 = new JTextField("0");
    JLabel got5Label = new JLabel("5 of ", JLabel.RIGHT);
    JTextField got5 = new JTextField("0");
    JLabel got6Label = new JLabel("6 of ", JLabel.RIGHT);
